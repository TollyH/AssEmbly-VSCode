...
const mnemonics: { [mnemonic: string]: MnemonicInfo } = {
	...
	"WCB": new MnemonicInfo([allOperands], "## Write Numeric Byte to Console"),
	"WCX": new MnemonicInfo([allOperands], "## Write Byte to Console as Hexadecimal"),
	"WCC": new MnemonicInfo([allOperands], "## Write Raw Byte to Console"),
	"WFN": new MnemonicInfo([allOperands], "## Write Number (64-bit) to File"),
	"WFB": new MnemonicInfo([allOperands], "## Write Numeric Byte to File"),
	"WFX": new MnemonicInfo([allOperands], "## Write Byte to File as Hexadecimal"),
	"WFC": new MnemonicInfo([allOperands], "## Write Raw Byte to File"),
	...
	"RCC": new MnemonicInfo([registerOperands], "## Read Raw Byte from Console"),
	"RFC": new MnemonicInfo([registerOperands], "## Read Raw Byte from File"),
